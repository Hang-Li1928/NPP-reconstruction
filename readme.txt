The package is a demo. Please download the zip file, put it in your desktop, and unzip it.

The area in the code is just a subset of our study areas. You can run the reconstructNPP_test.m firstly and then run the assign_coordinate_to_tif later.
